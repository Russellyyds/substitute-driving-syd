...
public class DriverInfoServiceImpl extends ServiceImpl<DriverInfoMapper, DriverInfo> implements DriverInfoService {
    ...
    public DriverLoginVo getDriverInfo(Long driverId) {
        ...
        DriverLoginVo driverInfoVo = new DriverLoginVo();
        BeanUtils.copyProperties(driverInfo, driverInfoVo);
        String faceModelId = driverInfo.getFaceModelId();
        boolean isArchiveFace = StringUtils.hasText(faceModelId);
        driverInfoVo.setIsArchiveFace(isArchiveFace);
        return driverInfoVo;
    }
    ...
    public Boolean updateDriverAuthInfo(UpdateDriverAuthInfoForm updateDriverAuthInfoForm) {
        if (updateDriverAuthInfoForm.getContactName().equals(updateDriverAuthInfoForm.getName())) {
            throw new GuiguException(ResultCodeEnum.DATA_ERROR);
        }
        if (updateDriverAuthInfoForm.getPhone().equals(updateDriverAuthInfoForm.getContactPhone())) {
            throw new GuiguException(ResultCodeEnum.DATA_ERROR);
        }
        //获取司机id
...
//        int i = driverInfoMapper.updateById(driverInfo);
    ...
    public Boolean isFaceRecognition(Long driverId) {
        LambdaQueryWrapper<DriverFaceRecognition> driverFaceRecognitionLambdaQueryWrapper = new LambdaQueryWrapper<>();
        driverFaceRecognitionLambdaQueryWrapper.eq(DriverFaceRecognition::getDriverId, driverId);
        driverFaceRecognitionLambdaQueryWrapper.eq(DriverFaceRecognition::getFaceDate, new DateTime().toString("yyyy-MM-dd"));
        Long count = driverFaceRecognitionMapper.selectCount(driverFaceRecognitionLambdaQueryWrapper);
        return count != 0;
    }
    ...
    public DriverInfoVo getDriverInfoOrder(Long driverId) {
        ...
        driverInfoVo.setDriverLicenseAge(year - firstYear);
        return driverInfoVo;
    }
